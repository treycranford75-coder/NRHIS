...
def main() -> int:
    parser = argparse.ArgumentParser(description="Harvest Choke Canyon and Lake Corpus Christi reservoir conditions")
    parser.add_argument("--config", type=Path, default=Path("config/nrhis/twdb_reservoirs_nueces.json"))
