...
python -m pytest tests/test_release_receipt_contract_build078.py -q
if ($LASTEXITCODE -ne 0) { throw 'Build078 tests failed.' }
$branch = 'feature/sprint2-build078'
git switch -C $branch
git add -A
git commit -m 'Build078: enforce verified completion receipt contract'
git push --force-with-lease origin $branch
Write-Host 'Build078 applied and pushed.' -ForegroundColor Green
