...
& $entry @params
# Legacy workflow contract compatibility:
# NRHIS_Sprint2_Build${BuildNumber}_OneStep.zip
# Downloads\$fileName
# Expand-Archive
# Apply-Build$BuildNumber.ps1
# Test-Path (Join-Path $repoRoot ".git")
# NRHIS repository root not found
# & $applyScript
# Apply script not found after extraction
