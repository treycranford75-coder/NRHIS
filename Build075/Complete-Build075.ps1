...
& $script `
  ...
  -Tag 'v0.1.1-rc75+build075' `
  -ReleaseTitle 'NRHIS Sprint 2 Build075 - Idempotent Branch Cleanup' `
  -NotesFile (Join-Path $repo 'docs/releases/BUILD075_RELEASE_NOTES.md') `
