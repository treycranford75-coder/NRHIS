# Build052 USGS Historical Backfill

Build052 adds restart-safe, chunked historical extraction from the USGS Instantaneous Values service for the configured Nueces-Frio basin stations.
