...
function Normalize-Commit([AllowNull()][string]$Value) {
...
$resolvedCommit = Normalize-Commit (Resolve-GitHubTagCommit -Repo $Repository -ReleaseTag $Tag)
$expectedCommit = Normalize-Commit $expectedCommit
