...
Build051 extends the production current-condition harvester with chunked date-range
...
def fetch_json(url: str, timeout_seconds: int = 60) -> bytes:
    request = urllib.request.Request(
        url,
        headers={"User-Agent": "NRHIS/0.1 Build051 (+https://github.com/treycranford75-coder/NRHIS)"},
    )
