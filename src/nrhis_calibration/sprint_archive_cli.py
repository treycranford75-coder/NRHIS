...
def main() -> int:
    ...
    if args.action == 'create':
        ...
        archive = create_sprint_archive(destination_root=args.destination_root, archive_id=args.archive_id, release_inventory=args.release_inventory, closeout_report=args.closeout_report, metadata=metadata)
